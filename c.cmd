...
cl -EHsc -I%RXREPOPATH%\Rx\CPP\src -I%RXREPOPATH%\Ix\CPP\src -I%LIBREPOPATH%\libraries -DUNICODE -D_UNICODE -DRXCPP_FORCE_USE_VARIADIC_TEMPLATES=1 -ZI -Fd"testbench.pdb" modernscratch.cpp
